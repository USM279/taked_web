  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-20">
        <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-up ltr">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold text-gray-900 leading-tight">
            From idea to reality, your business starts with{" "}
            <span className="relative">
              <span className="relative z-10">Taked</span>
          ...
          <p className="text-lg md:text-xl text-gray-700 font-body max-w-2xl mx-auto">
            Company formation, legal licenses, investor visas – all in one place
          </p>
