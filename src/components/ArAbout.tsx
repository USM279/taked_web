...
export const ArAbout = () => {
  return (
    <section id="about" className="bg-white py-20" dir="rtl">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-heading font-bold text-gray-900 mb-4">
            مـــــن نـــــحـــــن
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            نحن شركة متخصصة في تقديم حلول متكاملة للأعمال في الإمارات نساعد رواد
            الأعمال والمستثمرين على تحقيق أهدافهم بكل ثقة وسهولة
          </p>
        </div>
