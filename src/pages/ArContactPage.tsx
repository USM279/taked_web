...
export const ArContactPage = () => {
  ...
  useEffect(() => {
    applySeo({
      title: "تواصل مع خبراء تأسيس الشركات في دبي | تأكيد",
      description:
        "احصل على استشارة سريعة لتأسيس شركة في دبي أو استخراج رخصة تجارية وإقامة مستثمر. تواصل مع فريق تأكيد الآن.",
      path: "/ar/contact-us",
      language: "ar",
      alternates: {
        ar: "/ar/contact-us",
