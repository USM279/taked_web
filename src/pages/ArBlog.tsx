...
import { Calendar, ArrowLeft, BookOpen, Search } from "lucide-react";
...
export const ArBlogPage = () => {
  ...
  useEffect(() => {
    applySeo({
      title: "المدونة | تأكيد — خدمات تأسيس الشركات في دبي",
      description:
        "اقرأ أحدث المقالات والدليل الكامل حول تأسيس الشركات والرخص التجارية وتأشيرات المستثمر في الإمارات.",
      path: "/ar/blog",
      language: "ar",
      keywords:
        "مدونة تأسيس شركات دبي, رخصة تجارية الإمارات, تأشيرة مستثمر, خدمات حكومية",
      alternates: {
        ar: "/ar/blog",
        en: "/en/blog",
      },
  ...
  const filtered = posts.filter(
    (p) =>
      ...
      p.excerptAr?.toLowerCase().includes(search.toLowerCase())
  );
    ...
    <div className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="relative bg-gradient-to-br from-sky-950 via-sky-900 to-slate-900 pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 right-0 w-96 h-96 bg-sky-400 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
          <div className="absolute bottom-0 left-0 w-72 h-72 bg-blue-500 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
        </div>
        <div className="container mx-auto px-4 relative">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white leading-tight mb-4">
              دليلك الشامل لتأسيس
              <span className="text-sky-300"> الأعمال في الإمارات</span>
            </h1>
            <p className="text-sky-200 text-lg leading-relaxed mb-8">
              مقالات متخصصة حول تأسيس الشركات، الرخص التجارية، التأشيرات، وكل ما
              تحتاجه لبدء عملك في دبي.
            </p>
            ...
            <div className="relative max-w-lg">
              ...
              <input
                ...
                className="w-full pr-12 pl-4 py-3.5 bg-white rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-sky-300 shadow-lg"
              />
            </div>
          </div>
        </div>
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-700 mb-2">
              {search ? "لا توجد نتائج" : "لا توجد مقالات بعد"}
            </h2>
            <p className="text-gray-400 text-sm">
              {search
                ? "جرّب كلمة بحث مختلفة"
                : "سيتم نشر مقالات قريباً"}
            </p>
          </div>
        ) : (
          <>
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-xl font-bold text-gray-900">
                {search ? `نتائج البحث (${filtered.length})` : `أحدث المقالات (${filtered.length})`}
              </h2>
            </div>
                      ...
                      <div className="flex items-center gap-3 mt-auto">
                        <div className="flex items-center gap-1.5 text-xs text-gray-400">
                          ...
                          {filtered[0].publishedAt
                            ? new Date(filtered[0].publishedAt.seconds * 1000).toLocaleDateString("ar-AE", {
                                year: "numeric",
                                month: "long",
                                day: "numeric",
                              })
                        ...
                        <span className="flex items-center gap-1 text-sky-700 text-sm font-medium mr-auto group-hover:gap-2 transition-all">
                          اقرأ المقال
                    ...
                    <div className="p-5 flex flex-col flex-1">
                      ...
                      <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                        <div className="flex items-center gap-1.5 text-xs text-gray-400">
                          ...
                          {post.publishedAt
                            ? new Date(post.publishedAt.seconds * 1000).toLocaleDateString("ar-AE")
                            : ""}
                        </div>
      ...
      <section className="bg-gray-50 py-16">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">
            هل لديك سؤال حول تأسيس شركتك؟
          </h2>
          <p className="text-gray-500 mb-6 max-w-lg mx-auto">
            فريق تأكيد متاح للإجابة على جميع استفساراتك وتقديم الاستشارة المناسبة
          </p>
          <Link
            to="/ar/contact-us"
