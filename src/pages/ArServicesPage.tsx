...
export const ArServicesPage = () => {
  useEffect(() => {
    applySeo({
      title: "خدمات تأسيس الشركات في دبي | رخص تجارية وإقامة مستثمر",
      description:
        "خدمات تأسيس الشركات في دبي والإمارات: رخص تجارية، إقامة مستثمر، تأشيرات، معاملات حكومية، وخدمات قانونية متكاملة.",
      path: "/ar/services",
      language: "ar",
      keywords:
